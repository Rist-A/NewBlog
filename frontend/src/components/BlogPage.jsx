...
const accentColor = theme === 'dark' ? 'text-[#B8FF8C]' : 'text-green-600';
const accentBgColor = theme === 'dark' ? 'bg-[#B8FF8C33]' : 'bg-green-100';
...
<Link to="/" className="hover:text-[#B8FF8C]">Home</Link>
<Link to="/create" className="hover:text-[#B8FF8C]">Create Post</Link>
<Link to="/profile" className="hover:text-[#B8FF8C]">Profile</Link>
<Link to="/login" className="hover:text-[#B8FF8C]">Login</Link>
</nav>
</div>
</div>
)}
...
<div className="w-full h-screen relative overflow-hidden">
  ...
  >
    <div className="habesha-blog font-semibold text-[#B8FF8C] text-lg mb-2">
      Our blog
    </div>
    ...
    <div className="flex gap-x-4 mt-8 justify-center">
      <button
        className={`w-[118px] h-12 bg-[#B8FF8C] font-semibold flex items-center justify-center rounded-lg ${
...
currentPage === 1 ? "opacity-50 cursor-not-allowed" : "hover:text-[#B8FF8C]"
}`}
>
...
className={`flex gap-x-2 items-center ${textColor} ${
currentPage === totalPages ? "opacity-50 cursor-not-allowed" : "hover:text-[#B8FF8C]"
}`}
>
...
//           }`}
//         >
//           <div className="habesha-blog font-semibold text-[#B8FF8C] text-lg mb-2 transition-all duration-300">
//             Our blog
//           </div>
...
//             <button
//               className={`w-[118px] h-12 bg-[#B8FF8C] font-semibold flex items-center justify-center rounded-lg transition-all duration-300 ${
//                 textAnimation.fadeOut ? 'scale-90' : 'scale-100'
//               }`}
//               onClick={() => navigate("/login")}
//             >
...
//                 <div className="text-[#B8FF8C] text-sm font-semibold">
//                   {post.user_name} - {new Date(post.created_at).toLocaleDateString()}
//                 </div>
//                 <img
//                   src={post.user_image_url}
...
//                 }}
//               />
//               <div className="text-[#B8FF8C] text-sm font-semibold mt-2">
//                 {post.user_name}
//               </div>
//               <div className="text-[#7B7B7B] text-sm">
//                 {new Date(post.created_at).toLocaleDateString()}
//               </div>
//               <div className="text-[#B8FF8C] text-xs mt-1">
//                 {post.category}
//               </div>
//             </div>
