...
const ProfilePage = () => {
  ...
  if (!profileData) return (
    <div className="flex justify-center items-center h-screen bg-gray-900">
      <div className="text-gray-900">No profile data found</div>
    </div>
  );

  return (
    <div className={`min-h-screen bg-white text-gray-900 p-4 md:p-8 ${fontSizeMap[fontSize].base}`}>
      {/* Header Section */}
          ...
          <div className="flex gap-1">
            {['small', 'medium', 'large'].map(size => (
              <button 
                ...
                className={`px-2 py-1 rounded ${fontSize === size ? 'bg-white' : 'bg-white'} ${fontSizeMap[fontSize].button}`}
              >
      ...
      {/* Profile Section */}
      <div className="max-w-4xl mx-auto bg-white rounded-xl p-6 mb-8 shadow-lg relative transition-all duration-300 hover:shadow-2xl">
        {editMode && (
        ...
        <div className="flex flex-col md:flex-row items-center gap-6">
          <div className="relative group">
            ...
            />
            {editMode && (
              <label className="absolute bottom-0 right-0 bg-white p-2 rounded-full cursor-pointer hover:bg-white transition-colors shadow-md">
                <Camera size={18} />
                <input 
                  type="file" 
                  accept="image/*"
          ...
          <div className="text-center md:text-left">
            {editMode ? (
              <input
                ...
                className={`bg-white text-gray-900 ${fontSizeMap[fontSize].heading} font-bold p-2 rounded w-full focus:outline-none focus:ring-2 focus:ring-green-500`}
              />
            ) : (
            ...
            <div className="flex gap-4 mt-4 justify-center md:justify-start">
              <div className={`bg-white px-4 py-2 rounded-lg ${fontSizeMap[fontSize].button} hover:bg-white transition-colors`}>
            ...
            {!editMode && (
              <button 
                ...
                className={`mt-4 flex items-center gap-2 bg-white hover:bg-white px-4 py-2 rounded-lg transition-colors ${fontSizeMap[fontSize].button} shadow-md`}
              >
                <Edit size={18} />
                Edit Profile
              </button>
        ...
        {editMode && (
          <div className="mt-6">
            <button 
              ...
              className="flex items-center gap-2 text-white hover:text-gray-900 mb-4"
            >
              {showPasswordFields ? (
                <>
                  <ChevronUp size={16} />
              ...
              <div className="space-y-4 bg-white p-4 rounded-lg">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full bg-white text-gray-900 p-2 rounded focus:outline-none focus:ring-2 focus:ring-green-500 ${fontSizeMap[fontSize].subtitle}`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {profileData.posts.length > 0 ? (
              profileData.posts.map(post => (
                <div key={post.id} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group">
                  <img
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {profileData.savedPosts.length > 0 ? (
              profileData.savedPosts.map(saved => (
                <div key={saved.id} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group">
                  <img
